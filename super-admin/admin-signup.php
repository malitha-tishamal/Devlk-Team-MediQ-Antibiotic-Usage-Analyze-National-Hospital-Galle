                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    ...
                                    <form action="admin-register-process.php" method="POST" class="row g-3 needs-validation" novalidate>
                                        <div class="col-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#signup-form").submit(function(event) {
                ...
                $.ajax({
                    url: "admin-register-process.php", // Send form data to register.php
                    type: "POST",
