...
<head>
    ...
    <!-- Include html2pdf and SheetJS for PDF and Excel export -->
                ...
                <script>
                    function printTable() {
                        ...
                        printWindow.document.write(`
                            <html>
                            <head>
                                <title>Antibiotic Stock Report</title>
                    ...
                    function downloadPDF() {
                        ...
                        const opt = {
                            margin: 0.5,
                            filename: 'Antibiotic_Stock_Report.pdf',
                    ...
                    function downloadExcel() {
                        ...
                        XLSX.utils.book_append_sheet(wb, ws, "Antibiotic Stock");
                        XLSX.writeFile(wb, "Antibiotic_Stock_Report.xlsx");
                    }
                </script>
