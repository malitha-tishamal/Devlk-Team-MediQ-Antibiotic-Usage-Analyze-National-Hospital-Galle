...
<body>
    ...
    <?php if (isset($_SESSION['status'])): ?>
        ...
        <script>
            ...
            <?php if ($_SESSION['status'] == 'success'): ?>
                setTimeout(function() {
                    window.location.href = 'pages-release-antibiotic-odd.php'; // Redirect after 10 seconds
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Update Previous Details</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item">Pages</li>
                    <li class="breadcrumb-item active">Dispensing Antibiotics (Update Previous Details)</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex">
                                <h5 class="card-title">Dispensing Antibiotic (Update Previous Details)</h5>
                            </div>

                            <div class="container mt-3">
                                <form action="update_release_odd.php" method="POST" id="releaseForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" id="date" name="date" class="form-control w-50" placeholder="Enter Date" required>
                                    </div>
                                    ...
                                    <button type="submit" class="btn btn-success mt-3">Update Release</button>
                                    <button type="reset" class="btn btn-danger mt-3">Clear</button>
                                    <button class="btn btn-primary mt-3" onclick="window.location.href='pages-release-antibiotic.php'">Click to Update Today Details</button>
                                </form>
                            </div>
